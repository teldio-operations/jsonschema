...
[![Lint](https://github.com/teldio-operations/jsonschema/actions/workflows/lint.yaml/badge.svg)](https://github.com/teldio-operations/jsonschema/actions/workflows/lint.yaml)
...
Go version >= 1.27 is required. The fork tracks the toolchain the Fabric repos build with.
...
```json
{
  ...
  "$id": "https://github.com/teldio-operations/jsonschema_test/test-user",
  "$ref": "#/$defs/TestUser",
  "$defs": {
    "TestUser": {
      "oneOf": [
...
Support for `yaml` tags has now been removed. If you feel very strongly about this, we've opened a discussion to hear your comments: https://github.com/teldio-operations/jsonschema/discussions/28
...
```go
r := new(Reflector)
if err := r.AddGoComments("github.com/teldio-operations/jsonschema", "./"); err != nil {
  // deal with error
}
s := r.Reflect(&User{})
// output
